...
const STRK_USD_PRICE_ID = '0x6a182399ff70ccf3e06024898942028204125a819e519a335ffa4579e66cd870'
...
export function useStrkPrice() {
  ...
  useEffect(() => {
    const fetchPrice = async () => {
      try {
        const response = await fetch(`${PYTH_HERMES_API}?ids[]=${STRK_USD_PRICE_ID}`)
